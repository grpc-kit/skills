...
description: 维护并补全 grpc openapiv2 method 文档覆盖与语义质量。用于处理 `api/*/*/*` 下 `*.proto` 与 `*.gateway.yaml` 到 `*.openapiv2.yaml` 的 method 映射、缺失补齐、语义约束和 CI 门禁输出；当用户提到 method 覆盖率、tags/summary/description/examples 质量或高风险接口说明时应触发。
---
